...
export const SOLANA_HOST = process.env.REACT_APP_SOLANA_API_URL
    ...
    : 'http://localhost:8899' // here: https://api.devnet.solana.com
...
export const RECENT_TRANSACTIONS_WORMHOLE =
    'https://europe-west3-wormhole-315720.cloudfunctions.net/mainnet-recent?groupBy=address&numRows=2'
